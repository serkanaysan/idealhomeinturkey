...
!function(a) {
    ...
    var h = {
        afterClose: function(a, b) {
            var c = this;
            return c.$instance.off("next." + c.namespace + " previous." + c.namespace), c._swiper && (c._swiper.off("swipeleft", c._swipeleft).off("swiperight", c._swiperight), 
            c._swiper = null), a(b);
        },
    ...
    a.featherlight.extend(b, {
        ...
        createNavigation: function(b) {
			...
			if(b == 'previous'){ var yon = 'left'; }
			if(b == 'next'){ var yon = 'right'; }
			
            return a('<span title="' + b + '" class="' + this.namespace + "-" + b + '"><span class="fa fa-angle-' + yon + '">&nbsp;</span></span>').click(function() {
