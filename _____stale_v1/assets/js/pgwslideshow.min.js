...
(function(a) {
    a.fn.pgwSlideshow = function(q) {
        ...
        var g = function() {
            ...
            j.plugin.find(".ps-list > ul > li").each(function() {
                ...
                if (t.image) {
                    ...
                    if (t.thumbnail) {
                        s.html('<img src="https://www.idealhomeinturkey.com/mthumb.php?src=' + t.thumbnail + '&w=700&h=393&q=75&zc=3" alt="' + (t.title ? t.title : "") + '">')
                    }
                }
                if (t.link && t.thumbnail) {
                    s.html('<a href="' + t.link + '"  class="ProjectGallery"' + (t.linkTarget ? ' target="' + t.linkTarget + '"' : "") + ">" + s.html() + "</a>")
                }
        ...
        var d = function(x) {
            ...
            var r = x.find("img").attr("data-title");
