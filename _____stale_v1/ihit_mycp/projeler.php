                                    ...
                                    <thead>
									   ...
									   <tbody>
										...
										?>/</td>
											...
											<td>
												<!-- Sil -->
												<a href="projeler.php?projeSil=<?php echo $Project['id']; ?>" onclick="return confirm('Silmek istediğinizden emin misiniz?')"><i class="ti-trash"></i></a>
												<!-- Düzenleme -->
												<a class="various" data-fancybox-type="iframe" href="projeduzenle.php?ID=<?php echo $Project['id']; ?>">
													<i class="ti-pencil-alt2"></i>
												</a>
												&nbsp;&nbsp;&nbsp;&nbsp;
												<!-- Fotoğraflar -->
												<a title="Fotoğraflar" href="proje_fotograflari.php?ProjectID=<?php echo $Project['id']; ?>"><i class="ti-gallery"></i></a>
												<!-- Etrafında Ne Var -->
												<a title="Etrafında Ne Var" href="proje_env.php?ProjectID=<?php echo $Project['id']; ?>"><i class="ti-direction-alt"></i></a>
												<!-- Daire Özellikleri -->
												<a title="Daire Özellikleri" href="proje_ozellikleri.php?ProjectID=<?php echo $Project['id']; ?>"><i class="ti-align-right"></i></a>
												<!-- Dosyalar -->
												<a title="Dosyalar" href="dosyalar.php?ProjectID=<?php echo $Project['id']; ?>"><i class="ti-files"></i></a>
												<!-- Floor Plans -->
												<a title="Floor Plans" href="proje_fp.php?ProjectID=<?php echo $Project['id']; ?>"><i class="ti-layout-tab-window"></i></a>
												<!-- Aktif & Pasif -->
												<?php
													if($Project['status']==0){
												?>
												<a title="Aktif Yap" href="projeler.php?ProjectID=<?php echo $Project['id']; ?>&status=1"><i class="ti-control-play"></i></a>
												<?php }else{ ?>
												<a title="Pasif Yap" href="projeler.php?ProjectID=<?php echo $Project['id']; ?>&status=0"><i class="ti-control-pause"></i></a>
												<?php } ?>
