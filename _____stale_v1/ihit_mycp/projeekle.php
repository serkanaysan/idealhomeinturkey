...
if(isset($_POST['addNewProject'])){
	...
	if($CheckProject->rowCount() > 0){
		...
		$addProject = $DB->prepare("INSERT INTO ihit_projects (project_id,project_status,lang_id,city_id,price,youtube_id,map_lat,map_lng,slogan,description,related_1,related_2,related_3,zingat_rent_url,zingat_sale_url,status,short_text) VALUES (:project_id,:project_status,:lang_id,:city_id,:price,:youtube_id,:map_lat,:map_lng,:slogan,:description,:related_1,:related_2,:related_3,:zingat_rent_url,:zingat_sale_url,:status,:short_text)");
