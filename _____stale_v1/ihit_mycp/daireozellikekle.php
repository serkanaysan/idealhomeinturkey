...
if(isset($_POST['addNewFeature'])){
	...
	$addFeature = $DB->prepare("INSERT INTO ihit_home_features (name,lang_id) VALUES (:name,:lang_id)");
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
							...
							<?php echo $Msg; ?>
                                ...
                                <form method="post" action="daireozellikekle.php">
                                    <div class="row">
									
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Ozellik</label>
                                                <input type="text" name="name" class="form-control border-input" placeholder="Spor Salonu">
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
