<?php
	...
	$URL = 'http://apps.idealhomeinturkey.com/landing-page/landing/ideal-037';
	$Status = 1; // 1 Aktif | 0 Pasif ---- PROJE DURUMU
	$FormName = 'Arabic Landing Page';
	$ProjectName = 'Fortis İstanbul';
	$ProjectCode = 'ideal-037';
	$Title = 'Ideal Home in Turkey | Istanbul Real Estate Company | Your Ideal Home is Waiting For You!';
	$Slogan1 = 'لا تفوت الفرصة , المرونة بطرق الدفع , منزلك جاهز للتملك بطرق سهلة و بسيطة ';
	$Slogan2 = 'الموقع المتميز 10 دقائق عن مطار اتاتورك الدولي , فرصة كبيرة في التملك و الأستثمار العقاري المربح';
	...
	$Map = array(
		...
		'coordinate1' => '41.005915',
		'coordinate2' => '28.813101',
