<?php
	...
	$URL = 'http://apps.idealhomeinturkey.com/landing-page/landing/ideal-017';
	$Status = 1; // 1 Aktif | 0 Pasif ---- PROJE DURUMU
	$FormName = 'Arabic Landing Page';
	$ProjectName = 'Nurol Life';
	$ProjectCode = 'ideal-017';
	$Title = 'Ideal Home in Turkey | Istanbul Real Estate Company | Your Ideal Home is Waiting For You!';
	$Slogan1 = 'الخيال و الحياة التي لطالما حلمتم بها تنتظركم الأن , لا تدع فرصة تحقيق خيالك و احلامك تفوتك ';
	$Slogan2 = 'حياة الفخامة الرقي و الرفاهية تنتظرك في اكثر مشاريع اسطنبول فخامتاً رقيٍاً و رفاهيتاً ';
	...
	$Map = array(
		...
		'coordinate1' => '41.106906',
		'coordinate2' => '28.989237',
