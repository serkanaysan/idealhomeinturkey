<?php
	...
	$URL = 'http://apps.idealhomeinturkey.com/landing-page/landing/ideal-006';
	$Status = 1; // 1 Aktif | 0 Pasif ---- PROJE DURUMU
	$FormName = 'Arabic Landing Page';
	$ProjectName = 'Fi Side Bahçeşehir';
	$ProjectCode = 'ideal-006';
	$Title = 'Ideal Home in Turkey | Istanbul Real Estate Company | Your Ideal Home is Waiting For You!';
	$Slogan1 = 'سند التمليك العقاري اصبح جاهز بين يديك , لا تفوت الفرصة , نحن بأنتظاركم ';
	$Slogan2 = 'اسعار تبداء من 59,000 $ من المشاريع الرائدة في باهتشه شهير اسطنبول كما انه من اهمها';
	...
	$Map = array(
		...
		'coordinate1' => '41.078863',
		'coordinate2' => '28.657744',
