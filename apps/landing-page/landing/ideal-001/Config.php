<?php
	...
	$URL = 'http://apps.idealhomeinturkey.com/landing-page/landing/ideal-001';
	$Status = 1; // 1 Aktif | 0 Pasif ---- PROJE DURUMU
	$FormName = 'Arabic Landing Page';
	$ProjectName = 'Babacan Premium';
	$ProjectCode = 'ideal-001';
	$Title = 'Ideal Home in Turkey | Istanbul Real Estate Company | Your Ideal Home is Waiting For You!';
	$Slogan1 = 'نسبة الدفعة الأولى 25% , خيارات التقسيط 40 شهر , فرصة الصيف ما تزال مستمرة ';
	$Slogan2 = 'اسعار تبداء من 80,000 $ فرصة كبيرة في الأستثمار و التملك العقاري ';
	...
	$Map = array(
		...
		'coordinate1' => '41.008025',
		'coordinate2' => '28.681687',
