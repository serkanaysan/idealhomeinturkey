...
if(isset($_POST['addNewPhoto'])){
	...
	if ($ImageUpload->uploaded) {
		...
		if (!$ImageUpload->processed){
			...
			$addPhoto = $DB->prepare("INSERT INTO ihit_project_photos (title,description,image,project_id,rank) VALUES (:title,:description,:image,:project_id,:rank)");
			...
			if($addPhoto->rowCount() > 0){
				...
				$Msg = '
					...
					<div class="alert alert-success">
						<span><b> Başarılı - </b> Fotoğraf başarıyla eklendi.</span>
					</div>
				...
				$Msg = '
					...
					<div class="alert alert-danger">
						<span><b> Başarısız - </b> Fotoğraf eklenemedi.</span>
					</div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Fotograf Ekle</h4>
                            </div>
                            <div class="content">
							
							<?php echo $Msg; ?>
							
                                <form method="post" enctype="multipart/form-data" action="fotografekle.php?ProjectID=<?php echo $ProjectID; ?>">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="description" class="form-control border-input" placeholder="Aciklama">
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
												...
												?>
													<option value="<?php echo $Project['id']; ?>"<?php if($Project['id']==$ProjectID){ echo ' SELECTED'; } ?>><?php echo $Project['project_id']; ?></option>
													<?php } ?>
												</select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-info btn-fill btn-wd">Fotoğrafı Ekle</button>
                                    </div>
