...
if(isset($_POST['editTab'])){
	...
	$tabimage = $_POST['tabimage'];
	
	// Gelen bilgileri güncelleyelim.
	$updateTab = $DB->prepare("UPDATE ihit_hp_tabs SET rank = :rank, lang_id = :lang_id, tabtitle = :tabtitle, tabcontent = :tabcontent, tabimage = :tabimage WHERE id = :id");
                                ...
                                <form method="post" action="tabduzenle.php?ID=<?php echo $TabID; ?>">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Görsel</label>
                                                <input type="text" name="tabimage" class="form-control border-input" value="<?php echo $TabInfo['tabimage']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
