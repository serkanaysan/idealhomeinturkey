...
foreach($csv->data as $row){
	...
	// Insert Form Table
	$InsertForm = $DB->prepare('INSERT INTO ihit_form (fullname,country,created_at,form_name,email,phone,status,crm_posted,form_created_at) VALUES (:fullname,:country,:created_at,:form_name,:email,:phone,:status,:crm_posted,:form_created_at)');
	$InsertForm->execute(
