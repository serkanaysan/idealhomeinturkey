...
if(isset($_POST['addNewTab'])){
	...
	$addTab = $DB->prepare("INSERT INTO ihit_hp_tabs (lang_id,rank,tabtitle,tabcontent,tabimage) VALUES (:lang_id,:rank,:tabtitle,:tabcontent,:tabimage)");
                                ...
                                <form method="post" action="tabekle.php">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Görsel</label>
                                                <input type="text" name="tabimage" class="form-control border-input" placeholder="Görsel">
                                            </div>
                                        </div>
