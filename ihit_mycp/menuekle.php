...
if(isset($_POST['addNewMenu'])){
	...
	$addMenu = $DB->prepare("INSERT INTO ihit_menu (rank,menu_id,lang_id,title,url) VALUES (:rank,:menu_id,:lang_id,:title,:url)");
	$addMenu->execute(array(
	...
	if($addMenu->rowCount() > 0){
		...
		$Msg = '
			...
			<div class="alert alert-success">
				<span><b> Başarılı - </b> Menü başarıyla eklendi.</span>
			</div>
		...
		$Msg = '
			...
			<div class="alert alert-danger">
				<span><b> Başarısız - </b> Menü eklenemedi.</span>
			</div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
							...
							<?php echo $Msg; ?>
                                ...
                                <form method="post" action="menuekle.php">
                                    <div class="row">
                                        <div class="col-md-5">
										...
										<input type="hidden" name="addNewMenu" value="<?php echo uniqId(); ?>" />
										
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-info btn-fill btn-wd">Menü Ekle</button>
                                    </div>
